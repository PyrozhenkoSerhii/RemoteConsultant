...
module.exports = Object.freeze({
  language: {
    enum: ['Elementary', 'Beginner', 'Pre-intermediate', 'Intermediate', 'Upper-intermediate', 'Advanced', 'Proficient', 'A1', 'A2', 'B1', 'B2', 'C1', 'C2']
  },
  gender: {
  ...
  impact: {
    enum: ['buy', 'uncertain', 'not_buy']
  },
  mode: {
    enum: ['FILE_MODE', 'API_MODE'],
    default: 'FILE_MODE'
  },
  images: {
