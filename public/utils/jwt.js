...
exports.sign = function (user) {
  ...
  return _jsonwebtoken.default.sign(user.toJSON(), _config.default.get('api.secret'), {
    expiresIn: '24h'
  });
};

exports.verify = function (token) {
  _jsonwebtoken.default.verify(token, _config.default.get('secret'), function (err, decoded) {
    if (err) {
